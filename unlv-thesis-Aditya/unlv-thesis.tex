...
The census data from the Operations Support and Reporting Office was exported into a .csv file to be used by the analysis. The raw data consisted of a total of 17,709 freshmen student records captured cohort-wise from the academic year 2012 to 2016. The data consisted of a variety of information about each student, such as pre-college academics, standardized test scores, the social and economic status of the student, freshmen year academics and finally if the student was retained in the sophomore year. Additionally, the data had variables which were not related to the first year student retention rates. After some research and insights from experts of the domain, the raw data was cleaned to only include data that would be associated with the analysis. The following subsections describe in detail about the dataset. 
  ...
  \begin{table}[!t]
	...
	\begin{tabular}{|c|c|c|c|}
		\hline
		\bfseries No. & \bfseries Feature & \bfseries Type & \bfseries Description\\ 
		\hline
		...
		5 	& F1\_GPA 			&	Numerical		&	Term GPA for first fall term (admit term) 	\\ \hline
		6 	&F1\_GPA\_units		&	Numerical		&	Units completed in first fall (for GPA)		\\ \hline
		7 	&F1\_Complete		&	Binary	Nominal	&	Completed first fall term (final census)		\\ \hline
		8 	&S1\_Retain			&	Binary	Nominal	&	Enrolled in 1st spring (S1) - yes or no			\\ \hline
		9 	&S1\_EnrollCredits		&	Numerical		&	Count of career semester credits enrolled for S1 term \\ \hline
		10	&S1\_GPA\_units		&	Numerical		&	Units completed in S1 (for GPA)			  \\ \hline
		11	&S1\_GPA			&	Numerical		&	Term GPA for S1 term				\\ \hline
		12 	&S1\_Complete		&	Binary	Nominal	&	If student completed S1 term			\\ \hline
		13 	&Mom\_Edu\_Level		&	Multi Nominal		&	Highest education level of Mother		\\ \hline
		14 	&Dad\_Edu\_Level		&	Multi Nominal		&	Highest education level of Father			\\ \hline
		15 	&First\_Gen			&	Binary Nominal	&	If the kid is the first to attend college		\\ \hline
		16 	&Gender			&	Binary Nominal	&	Student Gender					\\ \hline
		17 	&Housing			&	Multi Nominal		&	on or off-campus housing				\\ \hline
		18 	&IPEDS\_Race		&	Multi Nominal		&	IPEDS race/ethnicity data				\\ \hline
		19 	&Marital\_Status		&	Multi Nominal		&	Marital status of the student in admit term	\\ \hline
		20 	&CoreHSGPA			&	Multi Nominal		&	Core high school GPA of the student		\\ \hline
		21 	&UnwHSGPA			&	Multi Nominal		&	Unweighted high school GPA of the student	\\ \hline
		22 	&SAT\_ACT\_Score		&	Numerical		&	ACT scores scaled to SAT scores			\\ \hline
		23 	&ACT\_SAT			&	Binary Nominal	&	If the student has taken ACT or SAT		\\ \hline
		24 	&F1\_Residency		&	Binary Nominal	&	In state or Out of State				\\ \hline
		25 	&F1\_TuitionRes		&	Multi Nominal		&	Tuition status of the student			\\ \hline
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[scale=0.65]{NotRetained_fre_dad_edu}
